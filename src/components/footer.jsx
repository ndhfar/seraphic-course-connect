...
export const Footer = () => {
  return (
    <div className="bg-secondary text-neutral-content pt-10 px-10 pb-5">
      {/* Details */}
      <footer className="footer">
        <aside>
          <h6 className="text-xl font-bold text-white">CourseConnect</h6>
          <p className="text-white">
            CourseConnect What is CourseConnect? It’s a platform that user can
            see information about course.
            <br />
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <div className="flex items-center gap-8 bg-black px-6 py-3 rounded-md bg-opacity-15 h-16">
            ...
            <Link
              href="mailto:cs@connect.com"
              className="btn bg-black text-white bg-opacity-25 border-none h-10"
            >
              cs@connect.com
            </Link>
          </div>
      ...
      <footer className="footer footer-center text-base-content pt-14">
        <aside>
          <p className="text-white">
            Copyright © {new Date().getFullYear()} - Course Connect. All Rights
            Reserved
          </p>
        </aside>
      </footer>
